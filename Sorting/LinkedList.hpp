...
private:
    ...
    void Concatenate(LinkedList<Type>*, Type, LinkedList<Type>*);   // Combine list together
    Node* ChoosePivot();                                            // Pick a pivot point for quick sort
    void Sort();                                                    // Compare two values
...
public:
    ...
    void QuickSort();    // Sort the list from lowest to highest
